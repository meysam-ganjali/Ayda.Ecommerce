$(function (e) {
    ...
    barChart.setOption({
        ...
        legend: {
            x: "center",
            y: "bottom",
            data: ["دسترسی مستقیم", "بازاریابی ایمیلی", "آگهی اتحادیه", "تبلیغات ویدئویی", "موتور جستجو"]
        },
    ...
    lineChart.setOption({
        ...
        xAxis: [{
            type: "category",
            boundaryGap: !1,
            data: ["دو", "سه", "چهار", "پنج", "جمعه", "شن", "یک"],
            axisLabel: {
                fontSize: 10,
                color: '#9aa0ac'
            }
