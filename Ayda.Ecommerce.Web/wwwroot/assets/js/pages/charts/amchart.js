...
function barChartWithImg() {
  ...
  chart.data = [{
    ...
    "bullet": "../../assets/images/user/user1-round.png"
  }, {
    "name": "علی",
    "points": 65456,
    "color": chart.colors.next(),
    "bullet": "../../assets/images/user/user2-round.png"
  }, {
    "name": "محمد",
    "points": 45724,
    "color": chart.colors.next(),
    "bullet": "../../assets/images/user/user3-round.png"
  }, {
    "name": "حسین",
    "points": 13654,
    "color": chart.colors.next(),
    "bullet": "../../assets/images/user/user4-round.png"
  },
  {
    "name": "رضا",
    "points": 32589,
    "color": chart.colors.next(),
    "bullet": "../../assets/images/user/user5-round.png"
  },
  {
    "name": "محسن",
    "points": 45895,
    "color": chart.colors.next(),
    "bullet": "../../assets/images/user/user6-round.png"
  },
  ];
