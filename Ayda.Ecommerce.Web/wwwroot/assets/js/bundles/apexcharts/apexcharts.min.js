...
! function (t, e) {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					s.size("120%", "180%", "-5%", "-40%"), t.filter(function (t) {
						...
						(s = a.enabled ? e.addShadow(t, a) : t).colorMatrix("matrix", [0, 0, 0, 0, .5, 0, 0, 0, 0, .5, 0, 0, 0, 0, .5, 0, 0, 0, 1, 0]).colorMatrix("saturate", 0)
				...
				value: function (t, e) {
					...
					return t.unfilter(!0), (new window.SVG.Filter).size("120%", "180%", "-5%", "-40%"), t.filter(function (t) {
						var e = null;
						e = d.isSafari() || d.isFirefox() || d.isIE() ? t.flood("black", n).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a) : t.flood("black", n).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a).merge(t.source), t.blend(t.source, e)
		...
		g = function () {
			...
			return s(t, [{
				...
				value: function (t, e, i, s, a, n, r) {
					var o = this,
						l = this.w;
					i || (i = t.attr("pathFrom")), s || (s = t.attr("pathTo")), (i.indexOf("undefined") > -1 || i.indexOf("NaN") > -1) && (i = "M 0 ".concat(l.globals.gridHeight), a = 1), (s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) && (s = "M 0 ".concat(l.globals.gridHeight), a = 1), l.globals.shouldAnimate || (a = 1), t.plot(i).animate(1, l.globals.easing, r).plot(i).animate(a, l.globals.easing, r).plot(s).afterAll(function () {
		...
		f = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					if (T.attr("id", "".concat(b, "-").concat(i)), T.attr("index", a), y && T.attr({
							"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")
						}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(T, A.config.states.normal.filter.type, A.config.states.normal.filter.value);
					else if (A.config.chart.dropShadow.enabled && (!A.config.chart.dropShadow.enabledSeries || A.config.chart.dropShadow.enabledSeries && -1 !== A.config.chart.dropShadow.enabledSeries.indexOf(a))) {
						var X = A.config.chart.dropShadow;
						S.dropShadow(T, X)
					}
					k && (T.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, T)), T.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, T)), T.node.addEventListener("mousedown", this.pathMouseDown.bind(this, T))), T.attr({
						pathTo: o,
						pathFrom: r
					});
					var Y = {
					...
					return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(n({}, Y, {
						speed: p,
						delay: f
					})), A.globals.dataChanged && z && M && C.animatePathsGradually(n({}, Y, {
						speed: x
					})), T
				}
			}, {
				...
				value: function (t, e, i, s, a) {
					...
					var g = !("donut" !== o.config.chart.type && "pie" !== o.config.chart.type && "bubble" !== o.config.chart.type),
				...
				value: function (t) {
					var e, i = this.w,
						...
						h = t.foreColor,
						c = t.opacity;
					return r || (r = "start"), h || (h = i.config.chart.foreColor), l = l || i.config.chart.fontFamily, (e = Array.isArray(n) ? i.globals.dom.Paper.text(function (t) {
				...
				value: function (t, e) {
					...
					"function" == typeof i.config.chart.events.dataPointMouseLeave && i.config.chart.events.dataPointMouseLeave(e, this.ctx, {
						...
						dataPointIndex: n,
						w: i
					}]), "none" !== i.config.states.active.filter.type && "true" === t.node.getAttribute("selected") || "none" !== i.config.states.hover.filter.type && s.getDefaultFilter(t)
				}
			}, {
				key: "pathMouseDown",
				value: function (t, e) {
	...
	var p = {
		...
		m = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.graphics = new f(this.ctx), "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.horizontal && (this.invertAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
			}
			return s(t, [{
				key: "drawAnnotations",
				value: function () {
				...
				value: function (t, e, i) {
					...
					if (!(o < 0 || o > s.globals.gridWidth)) {
						var l = this.graphics.drawLine(o + t.offsetX, 0 + t.offsetY, o + t.offsetX, s.globals.gridHeight + t.offsetY, t.borderColor, r);
				...
				value: function (t, e, i) {
					...
					} else s = a.globals.gridHeight - (t.y - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight);
					var l = t.label.text ? t.label.text : "",
						h = this.graphics.drawLine(0 + t.offsetX, s + t.offsetY, a.globals.gridWidth + t.offsetX, s + t.offsetY, t.borderColor, n);
				...
				value: function (t, e, i) {
					...
					if (this.invertAxis && console.warn("Point annotation is not supported in horizontal bar charts."), "string" == typeof t.x) {
						...
						var h = t.y;
						null === t.y && (h = s.globals.series[t.seriesIndex][o]), n = s.globals.gridHeight - (h - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight) - parseInt(t.label.style.fontSize) - t.marker.size, r = s.globals.gridHeight - (h - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight)
					} else a = (t.x - s.globals.minX) / (s.globals.xRange / s.globals.gridWidth), n = s.globals.gridHeight - (parseInt(t.y) - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight) - parseInt(t.label.style.fontSize) - t.marker.size, r = s.globals.gridHeight - (t.y - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight);
				...
				value: function (t, e) {
					...
					"vertical" === e.label.orientation && (r = e.label.style.padding.left, o = e.label.style.padding.right, a = e.label.style.padding.top, n = e.label.style.padding.bottom);
					var l = s.left - i.left - a,
						h = s.top - i.top - r;
					return this.graphics.drawRect(l, h, s.width + a + n, s.height + r + o, 0, e.label.style.background, 1, e.label.borderWidth, e.label.borderColor, 0)
				}
			}, {
				...
				value: function (t, e, i) {
					...
					return P.before(T), e && z.globals.memory.methodsToExec.push({
						context: L,
						method: L.addText,
						params: {
							x: s,
			...
			return s(t, [{
				...
				value: function () {
					...
					i && i.length && (t.xaxis.labels.formatter = function (t) {
						return e(i[t - 1])
					}), t.xaxis.categories = [], t.labels = [], t.chart.zoom.enabled = !1
				}
			}, {
				key: "bubble",
				value: function () {
		...
		v = function () {
			...
			return s(t, [{
				...
				value: function () {
					...
					if (e = n.xRange / n.gridWidth, i = Math.abs(n.initialmaxX - n.initialminX) / n.gridWidth, t = n.yRange / n.gridWidth, s = n.xRange / n.gridHeight, a = n.zRange / n.gridHeight * 16, n.minY !== Number.MIN_VALUE && 0 !== Math.abs(n.minY)) {
				...
				value: function (t) {
					...
					return s.yLogRatio = t.slice(), s.logYRange = s.yRange.map(function (t, a) {
						if (i.config.yaxis[a] && e.w.config.yaxis[a].logarithmic) {
							var n, r = Number.MIN_SAFE_INTEGER,
			...
			return s(i, [{
				...
				value: function () {
					...
					if (e && "object" === t(e)) {
						...
						e.chart.brush && e.chart.brush.enabled && (r = s.brush(r)), e.chart.stacked && "100%" === e.chart.stackType && s.stacked100(), e.xaxis = e.xaxis || window.Apex.xaxis || {};
						var o = v.checkComboSeries(e.series);
						"line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "between" === e.xaxis.tickPlacement || s.convertCatToNumeric(), (e.chart.sparkline && e.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (r = s.sparkline(r)), n = d.extend(a, r)
					}
			...
			return s(t, [{
				...
				value: function (t, e) {
					...
					var o = this.getFillColors(),
						...
						c = l;
					return e.color && (l = e.color), -1 === l.indexOf("rgb") ? c = d.hexToRgba(l, h) : l.indexOf("rgba") > -1 && (h = "0." + d.getOpacityFromRGBA(o[this.seriesIndex])), "pattern" === r.fill.type && (a = this.handlePatternFill(a, l, h, c)), "gradient" === r.fill.type && (n = this.handleGradientFill(n, l, h, this.seriesIndex)), r.fill.image.src.length > 0 && "image" === r.fill.type ? e.seriesNumber < r.fill.image.src.length ? (this.clippedImgArea({
						opacity: h,
						image: r.fill.image.src[e.seriesNumber],
						patternID: "pattern".concat(i.globals.cuid).concat(e.seriesNumber + 1)
					}), s = "url(#pattern".concat(i.globals.cuid).concat(e.seriesNumber + 1, ")")) : s = c : s = "gradient" === r.fill.type ? n : "pattern" === r.fill.type ? a : c, e.solid && (s = c), s
				}
			}, {
				key: "getFillColors",
				value: function () {
			...
			return s(t, [{
				...
				value: function (t, e, i) {
					var s, a = this,
						...
						o = null,
						l = new f(this.ctx);
					if (n.globals.markers.size[e] > 0 && (o = l.group({
							class: "apexcharts-series-markers"
						})).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")), r.x instanceof Array)
						for (var h = function (t) {
								var h = i;
								1 === i && 0 === t && (h = 0), 1 === i && 1 === t && (h = 1);
								var c = "apexcharts-marker";
								if ("line" !== n.config.chart.type && "area" !== n.config.chart.type || n.globals.comboCharts || n.config.tooltip.intersect || (c += " no-pointer-events"), Array.isArray(n.config.markers.size) ? n.globals.markers.size[e] > 0 : n.config.markers.size > 0) {
									d.isNumber(r.y[t]) ? c += " w".concat((Math.random() + 1).toString(36).substring(4)) : c = "apexcharts-nullpoint";
									var u = a.getMarkerConfig(c, e);
									n.config.markers.discrete.map(function (t) {
										t.seriesIndex === e && t.dataPointIndex === h && (u.pointStrokeColor = t.strokeColor, u.pointFillColor = t.fillColor, u.pSize = t.size)
									}), (s = l.drawMarker(r.x[t], r.y[t], u)).attr("rel", h), s.attr("j", h), s.attr("index", e), s.node.setAttribute("default-marker-size", u.pSize), a.setSelectedPointFilter(s, e, h), a.addEvents(s), o && o.add(s)
								} else void 0 === n.globals.pointsArray[e] && (n.globals.pointsArray[e] = []), n.globals.pointsArray[e].push([r.x[t], r.y[t]])
							}, c = 0; c < r.x.length; c++) h(c);
					return o
				}
			}, {
				key: "getMarkerConfig",
				...
				value: function (t, e, i) {
					...
					if (x.attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), h.x instanceof Array)
						for (var m = 0; m < h.x.length; m++) {
							...
							c !== 1 / 0 && (y = s.globals.seriesZ[l][b] / c, void 0 === this.radiusSizes[l] && this.radiusSizes.push([]), this.radiusSizes[l].push(y)), s.config.chart.animations.enabled || (v = y);
							var w = h.x[m],
								k = h.y[m];
							if (k = k || 0, v = v || 0, 0 === (w = w || 0) && 0 === k || void 0 === s.globals.series[l][b]) return;
							var C = n.drawCircle(v);
							if (C.attr({
									cx: w,
									cy: k,
									fill: p
								}), s.config.chart.dropShadow.enabled && r.dropShadow(C, {
								...
								var L = 1;
								s.globals.resized || (L = s.config.chart.animations.speed), a.animateCircleRadius(C, 0, y, L, s.globals.easing)
							}
							if (s.globals.dataChanged)
								if (this.dynamicAnim) {
									var z, M = s.config.chart.animations.dynamicAnimation.speed,
										P = void 0,
										E = void 0,
										T = void 0;
									null != (z = s.globals.previousPaths[l] && s.globals.previousPaths[l][e]) && (P = z.x, E = z.y, T = void 0 !== z.r ? z.r : y);
									for (var X = 0; X < s.globals.collapsedSeries.length; X++) s.globals.collapsedSeries[X].index === l && (M = 1, y = 0);
									0 === w && 0 === k && (y = 0), a.animateCircle(C, {
										cx: P,
										cy: E,
										r: T
									}, {
							...
							C.attr({
								...
								j: b,
								index: l,
								"default-marker-size": y
							});
							var Y = new S(this.ctx);
							Y.setSelectedPointFilter(C, l, b), Y.addEvents(C), C.node.classList.add("apexcharts-marker"), x.add(C), d.add(x)
						}
				}
			}, {
		...
		L = function () {
			...
			return s(t, [{
					...
					for (var c = 0; c < t.x.length; c++)
						if (r = t.x[c] + n.offsetX, o = t.y[c] + n.offsetY - s.globals.markers.size[e] - 5, !isNaN(r)) {
							...
							var d = s.globals.series[e][l],
								u = "";
							if ("bubble" === s.config.chart.type) u = s.globals.seriesZ[e][l], o = t.y[c] + s.config.dataLabels.offsetY, o = new C(this.ctx).centerTextInBubble(o, e, l).y;
							else void 0 !== d && (u = s.config.dataLabels.formatter(d, {
								seriesIndex: e,
								dataPointIndex: l,
								w: s
							}));
				...
				value: function (t) {
					...
					if (t.offsetCorrection && (g = this.dataLabelsCorrection(s, a, o, n, r, d, parseInt(c.style.fontSize))), e.globals.zoomed || (s = g.x, a = g.y), g.drawnextLabel) {
						var p = i.drawText({
							width: 100,
		...
		z = function () {
			function t(i, s) {
				e(this, t), this.ctx = i, this.w = i.w;
				var a = this.w;
				this.barOptions = a.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = a.config.stroke.width, this.isNullValue = !1, this.xyRatios = s, null !== this.xyRatios && (this.xRatio = s.xRatio, this.yRatio = s.yRatio, this.invertedXRatio = s.invertedXRatio, this.invertedYRatio = s.invertedYRatio, this.baseLineY = s.baseLineY, this.baseLineInvertedY = s.baseLineInvertedY), this.minXDiff = Number.MAX_SAFE_INTEGER, this.yaxisIndex = 0, this.seriesLen = 0
			}
			return s(t, [{
				key: "draw",
				value: function (t, e) {
					var i = this,
						...
						n = new A(this.ctx),
						r = new v(this.ctx, s);
					this.series = r.getLogSeries(t), t = this.series, this.yRatio = r.getLogYRatios(this.yRatio), this.initVariables(t);
					var o = a.group({
						class: "apexcharts-bar-series apexcharts-plot-series"
					});
					o.attr("clip-path", "url(#gridRectMask".concat(s.globals.cuid, ")"));
					for (var l = function (r, l) {
							...
							x = S.y, w = S.barHeight, c = S.yDivision, u = S.zeroW, p = S.x, k = S.barWidth, h = S.xDivision, d = S.zeroH, i.horizontal || b.push(p + k / 2);
							for (var C = a.group({
									class: "apexcharts-datalabels"
								}), L = function (e, a) {
									void 0 === i.series[r][e] || null === t[r][e] ? i.isNullValue = !0 : i.isNullValue = !1, s.config.stroke.show && (A = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[v] : i.strokeWidth);
									var o = null;
									o = i.isHorizontal ? i.drawBarPaths({
										...
										strokeWidth: A,
										elSeries: y
									}), g = o.pathTo, f = o.pathFrom, x = o.y, p = o.x, e > 0 && b.push(p + k / 2), m.push(x);
									var S = i.barOptions.distributed ? e : r,
										L = null;
									i.barOptions.colors.ranges.length > 0 && i.barOptions.colors.ranges.map(function (i) {
										t[r][e] >= i.from && t[r][e] <= i.to && (L = i.color)
									});
									var z = n.fillPath(y, {
										seriesNumber: i.barOptions.distributed ? S : v,
										color: L
									});
									y = i.renderSeries({
										realIndex: v,
								...
								}, z = 0, M = s.globals.dataPoints; z < s.globals.dataPoints; z++, M--) L(z);
				...
				value: function (t) {
					...
					var w = a / v.config.chart.animations.animateGradually.delay * (v.config.chart.animations.speed / v.globals.dataPoints) / 2.4,
						k = y.renderPaths({
							i: n,
							j: a,
							realIndex: e,
				...
				value: function (t) {
					...
					for (var s = 0; s < t.length; s++)
						if (t[s].length > 0 && (this.seriesLen = this.seriesLen + 1, this.totalItems += t[s].length), i.globals.isXNumeric) {
							...
							for (var a = 0; a < t[s].length; a++) i.globals.seriesX[s][a] > i.globals.minX && i.globals.seriesX[s][a] < i.globals.maxX && this.visibleItems++
				...
				value: function () {
					...
					if (this.isHorizontal) a = (i = l.globals.gridHeight / l.globals.dataPoints) / this.seriesLen, l.globals.isXNumeric && (a = (i = l.globals.gridHeight / this.totalItems) / this.seriesLen), a = a * parseInt(this.barOptions.barHeight) / 100, o = this.baseLineInvertedY + l.globals.padHorizontal, e = (i - a * this.seriesLen) / 2;
					else {
						if (n = (s = l.globals.gridWidth / this.visibleItems) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100, l.globals.isXNumeric) {
							if (this.minXDiff === Number.MAX_SAFE_INTEGER) {
								var h = l.globals.labels.length;
								l.globals.timelineLabels.length > 0 && (h = l.globals.timelineLabels.length), h < 3 && (h = 3), this.minXDiff = (l.globals.maxX - l.globals.minX) / h
							}
							n = (s = this.minXDiff / this.xRatio) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100
						}
						r = l.globals.gridHeight - this.baseLineY[this.yaxisIndex], t = l.globals.padHorizontal + (s - n * this.seriesLen) / 2
					}
					return {
						x: t,
						y: e,
				...
				value: function (t) {
					...
					a = u.move(r, b), n = u.move(r, b), d.globals.previousPaths.length > 0 && (n = this.getPathFrom(x, p, !0));
					var v = {
							barHeight: i,
							strokeWidth: s,
							barYPosition: b,
					...
					if (a = a + u.line(y.newX, b) + y.path + u.line(r, b + i - s) + u.line(r, b), n = n + u.line(r, b) + y.ending_p_from + u.line(r, b + i - s) + u.line(r, b + i - s) + u.line(r, b), d.globals.isXNumeric || (l += h), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
				...
				value: function (t) {
					...
					n = u.move(b, l), r = u.move(b, l), d.globals.previousPaths.length > 0 && (r = this.getPathFrom(x, p, !0));
					var v = {
							barWidth: o,
							strokeWidth: h,
							barXPosition: b,
							y: s = void 0 === this.series[g][p] || null === this.series[g][p] ? l : l - this.series[g][p] / this.yRatio[this.yaxisIndex],
							zeroH: l
						},
						y = this.barEndingShape(d, v, this.series, g, p);
					if (n = n + u.line(b, y.newY) + y.path + u.line(b + o - h, l) + u.line(b, l), r = r + u.line(b, l) + y.ending_p_from + u.line(b + o - h, l) + u.line(b + o - h, l) + u.line(b, l), d.globals.isXNumeric || (i += a), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
						m >= this.barOptions.colors.backgroundBarColors.length && (m = 0);
						var w = this.barOptions.colors.backgroundBarColors[m],
				...
				value: function (t) {
					...
					return v = this.isHorizontal ? this.calculateBarsDataLabelsPosition({
						x: e,
						y: i,
						i: s,
						j: a,
				...
				value: function (t) {
					...
					var m = !!(r > i.globals.gridHeight - this.baseLineY[this.yaxisIndex] && 0 !== Math.abs(this.baseLineY[this.yaxisIndex])),
						b = 0 !== Math.abs(i.globals.minYArr[n]);
					switch (d.position) {
						case "center":
							c = r + p / 2 + h.height / 2 - f, b && (c = m ? r + p / 2 + h.height / 2 + f : r + p / 2 + h.height / 2 - f);
							break;
						case "bottom":
							c = b ? m ? r + p + h.height + u + f : r + p - h.height / 2 + u - f : i.globals.gridHeight - h.height / 2 - f;
							break;
						case "top":
					...
					if (void 0 !== i[s][a] || null !== i[s][a]) {
						...
						switch (p && (x = -e.barWidth / 2 - e.strokeWidth), t.config.chart.stacked || ("arrow" === this.barOptions.endingShape ? g += x : "rounded" === this.barOptions.endingShape && (g += x / 2)), this.barOptions.endingShape) {
							case "flat":
								...
								break;
							case "arrow":
								d = n.line(e.barXPosition + (e.barWidth - e.strokeWidth) / 2, g - x) + n.line(e.barXPosition + e.barWidth - e.strokeWidth, g), u = n.line(e.barXPosition + e.barWidth - e.strokeWidth, e.zeroH);
								break;
							case "rounded":
								d = n.quadraticCurve(e.barXPosition + (e.barWidth - e.strokeWidth) / 2, g - x, e.barXPosition + e.barWidth - e.strokeWidth, g)
						}
					}
					return {
						path: d,
		...
		M = function (t) {
			...
			return r(i, z), s(i, [{
				...
				value: function (t, e) {
					var i = this,
						s = this.w;
					this.graphics = new f(this.ctx), this.fill = new A(this.ctx), this.bar = new z(this.ctx, this.xyRatios);
					...
					this.zeroSerieses = [], this.endingShapeOnSeriesNumber = t.length - 1, this.checkZeroSeries({
						series: t
					});
					...
					for (var o = 0, l = 0, h = function (a, n) {
							var h = void 0,
								c = void 0,
								d = void 0,
								u = void 0,
							...
							l = A.y, b = A.barHeight, u = A.yDivision, f = A.zeroW, o = A.x, v = A.barWidth, d = A.xDivision, g = A.zeroH, i.yArrj = [], i.yArrjF = [], i.yArrjVal = [], i.xArrj = [], i.xArrjF = [], i.xArrjVal = [];
							for (var S = function (e) {
									s.config.stroke.show && (k = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[m] : i.strokeWidth);
									var r = null;
									r = i.isHorizontal ? i.drawBarPaths({
										...
										strokeWidth: k,
										elSeries: y
									}), h = r.pathTo, c = r.pathFrom, l = r.y, o = r.x, p.push(o), x.push(l);
									var A = s.config.plotOptions.bar.distributed ? e : a,
										S = null;
									i.barOptions.colors.ranges.length > 0 && i.barOptions.colors.ranges.map(function (i, s) {
										t[a][e] >= i.from && t[a][e] <= i.to && (S = i.color)
									});
									var C = i.fill.fillPath(y, {
										seriesNumber: i.barOptions.distributed ? A : m,
										color: S
									});
									y = i.renderSeries({
										realIndex: m,
							...
							s.globals.seriesXvalues[m] = p, s.globals.seriesYvalues[m] = x, i.prevY.push(i.yArrj), i.prevYF.push(i.yArrjF), i.prevYVal.push(i.yArrjVal), i.prevX.push(i.xArrj), i.prevXF.push(i.xArrjF), i.prevXVal.push(i.xArrjVal), r.add(y)
				...
				value: function (t, e, i, s, a, n) {
					var r, o, l = this.w;
					return this.isHorizontal ? (r = (r = s = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight) / 100, n = this.baseLineInvertedY + l.globals.padHorizontal, e = (s - r) / 2) : (o = i = l.globals.gridWidth / l.globals.dataPoints, o = l.globals.isXNumeric ? (i = this.minXDiff / this.xRatio) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100 : o * parseInt(l.config.plotOptions.bar.columnWidth) / 100, a = this.baseLineY[this.yaxisIndex] + 1, t = l.globals.padHorizontal + (i - o) / 2), {
						x: t,
						y: e,
						yDivision: s,
						xDivision: i,
				...
				key: "drawBarPaths",
				value: function (t) {
					for (var e, i = t.indexes, s = t.barHeight, a = t.strokeWidth, n = t.pathTo, r = t.pathFrom, o = t.zeroW, l = t.x, h = t.y, c = t.yDivision, d = t.elSeries, u = this.w, g = h, f = i.i, p = i.j, x = i.realIndex, m = i.bc, b = 0, v = 0; v < this.prevXF.length; v++) b += this.prevXF[v][p];
					if (f > 0) {
						var y = o;
						this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + b : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - b), e = y
					} else e = o;
				...
				value: function (t) {
					...
					if (u > 0 && !d.globals.isXNumeric || u > 0 && d.globals.isXNumeric && d.globals.seriesX[u - 1][g] === d.globals.seriesX[u][g]) {
						...
						m = this.prevYVal[u - 1][g] < 0 ? this.series[u][g] >= 0 ? w - v : w : this.series[u][g] >= 0 ? w : w + v
					...
					if (this.series.length > 1 && u !== this.endingShapeOnSeriesNumber && (A.path = this.graphics.line(b + o - h, A.newY)), this.yArrj.push(A.newY), this.yArrjF.push(Math.abs(m - A.newY)), this.yArrjVal.push(this.series[u][g]), n = this.graphics.move(b, m), r = this.graphics.move(b, m), d.globals.previousPaths.length > 0 && (r = this.bar.getPathFrom(f, g, !1)), n = n + this.graphics.line(b, A.newY) + A.path + this.graphics.line(b + o - h, m) + this.graphics.line(b, m), r = r + this.graphics.line(b, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b, m), d.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === u) {
			...
			return r(i, z), s(i, [{
				...
				value: function (t, e) {
					...
					for (var o = 0, l = 0; o < t.length; o++, l++) {
						...
						p = C.y, w = C.barHeight, g = C.x, k = C.barWidth, h = C.xDivision, c = C.zeroH, m.push(g + k / 2);
						for (var L = s.group({
								class: "apexcharts-datalabels"
							}), z = 0, M = i.globals.dataPoints; z < i.globals.dataPoints; z++, M--) {
							void 0 === this.series[o][z] || null === t[o][z] ? this.isNullValue = !0 : this.isNullValue = !1, i.config.stroke.show && (S = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[b] : this.strokeWidth);
							var P, E = this.drawCandleStickPaths({
								indexes: {
									i: o,
									j: z,
									realIndex: b,
							...
							d = E.pathTo, u = E.pathFrom, p = E.y, g = E.x, P = E.color, z > 0 && m.push(g + k / 2), x.push(p);
							var T = a.fillPath(y, {
									seriesNumber: b,
									color: P
								}),
				...
				value: function (t) {
					...
					return c.move(S, o), n = c.move(S, o), h.globals.previousPaths.length > 0 && (n = this.getPathFrom(b, u, !0)), void 0 === this.series[d][u] || null === this.series[d][u] ? k = o : (k = o - k / m, A = o - A / m, y = o - v.h / m, w = o - v.l / m), a = c.move(S, A) + c.line(S + r / 2, A) + c.line(S + r / 2, y) + c.line(S + r / 2, A) + c.line(S + r, A) + c.line(S + r, k) + c.line(S + r / 2, k) + c.line(S + r / 2, w) + c.line(S + r / 2, k) + c.line(S, k) + c.line(S, A - l / 2), h.globals.isXNumeric || (i += s), {
						pathTo: a,
						pathFrom: n,
						x: i,
						y: A,
		...
		X = function () {
			function t(i, s) {
				e(this, t), this.ctx = i, this.w = i.w, this.xRatio = s.xRatio, this.yRatio = s.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.width
			}
			return s(t, [{
				key: "draw",
				value: function (t) {
					...
					for (var a = e.globals.gridWidth / e.globals.dataPoints, n = e.globals.gridHeight / e.globals.series.length, r = 0, o = t.length - 1; o >= 0; o--) {
						var l = i.group({
							class: "apexcharts-series apexcharts-heatmap-series ".concat(e.globals.seriesNames[o].toString().replace(/ /g, "-")),
							rel: o + 1,
							"data:realIndex": o
						});
						...
						for (var c = 0, g = 0; g < t[o].length; g++) {
							...
							if (w.attr({
									cx: c,
									cy: r
								}), w.node.classList.add("apexcharts-heatmap-rect"), l.add(w), w.attr({
									fill: b,
									i: o,
									index: o,
									j: g,
									...
									color: b
								}), w.node.addEventListener("mouseenter", i.pathMouseEnter.bind(this, w)), w.node.addEventListener("mouseleave", i.pathMouseLeave.bind(this, w)), w.node.addEventListener("mousedown", i.pathMouseDown.bind(this, w)), e.config.chart.animations.enabled && !e.globals.dataChanged) {
								var k = 1;
							...
							if (e.globals.dataChanged) {
								...
								if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
									...
									var S = e.globals.previousPaths[o] && e.globals.previousPaths[o][g] && e.globals.previousPaths[o][g].color;
				...
				value: function (t, e) {
					...
					a.colorScale.ranges.length > 0 && a.colorScale.ranges.map(function (t, e) {
						s >= t.from && s <= t.to && (r = t.color, o = t.from, l = t.to, h = Math.abs(l) + Math.abs(o), d = 100 * s / h)
					});
					return {
						color: r,
						percent: d
			...
			return s(t, [{
				...
				value: function (t) {
					for (var e = this.w, i = new f(this.ctx), s = i.group({
						...
						}), a = 0, n = 0; n < t.length; n++) a += d.negToZero(t[n]);
					var r = [],
						o = i.group();
					0 === a && (a = 1e-5);
				...
				value: function (t, e) {
					...
					for (var g = 0; g < t.length; g++) {
						var p = a.group({
							class: "apexcharts-series apexcharts-pie-series ".concat(i.globals.seriesNames[g].toString().replace(/ /g, "-")),
						...
						if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (k = (h - o) / this.fullAngle * i.config.chart.animations.speed, this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
							...
							if (0 !== x) {
								...
								P.node.classList.add("apexcharts-pie-label"), i.config.chart.animations.animate && !1 === i.globals.resized && (P.node.classList.add("apexcharts-pie-label-delay"), P.node.style.animationDelay = i.config.chart.animations.speed / 940 + "s"), this.sliceLabels.push(P)
							}
						}
					}
					return r
				...
				value: function (t, e, i, s, a, n) {
					...
					l.globals.dataChanged && n.shouldSetPrevPaths && (r = o.getPiePath({
						...
						d: r
					})), 0 !== c.dur ? t.animate(c.dur, l.globals.easing, c.animBeginArr[c.i]).afterAll(function () {
						"pie" !== l.config.chart.type && "donut" !== l.config.chart.type || this.animate(300).attr({
							"stroke-width": l.config.stroke.width
						})
					}).during(function (l) {
						d = g + (s - g) * l, n.animateStartingPos && (d = a + (s - a) * l, u = e - a + (i - (e - a)) * l), r = o.getPiePath({
							me: o,
							startAngle: u,
							angle: d,
							size: h
				...
				value: function (t) {
					...
					var h = Math.PI * (l - 90) / 180,
						...
						m = s > 180 ? 1 : 0;
					return "donut" === n.config.chart.type ? ["M", c, u, "A", a, a, 0, m, 1, g, f, "L", p.x, p.y, "A", e.donutSize, e.donutSize, 0, m, 0, x.x, x.y, "L", c, u, "z"].join(" ") : "pie" === n.config.chart.type ? ["M", c, u, "A", a, a, 0, m, 1, g, f, "L", e.centerX, e.centerY, "L", c, u].join(" ") : ["M", c, u, "A", a, a, 0, m, 1, g, f].join(" ")
				}
			}, {
				...
				value: function (e, i) {
					...
					i.total.show && s.globals.series.length > 1 ? new t(this.ctx).printInnerLabels(i, i.total.label, i.total.formatter(s)) : null !== a && s.globals.series.length > 1 && (a.style.opacity = 0)
				}
			}]), t
		}(),
		I = function () {
				...
				value: function (t) {
					...
					if (this.yaxisLabels = this.graphics.group({
							...
							for (var f = 0; f < l.linePathsTo.length; f++) {
								var p = e.graphics.renderPaths(n({}, d, {
			...
			return r(i, Y), s(i, [{
				...
				value: function (t) {
					...
					for (var o = 0; o < t.series.length; o++) {
						...
						l.add(p), p.attr("id", "apexcharts-radialbarTrack-" + o), new Y(this.ctx).animatePaths(p, {
							centerX: t.centerX,
							centerY: t.centerY,
							endAngle: g,
							startAngle: d,
				...
				value: function (t) {
					...
					var x = new Y(this.ctx),
						m = null;
					this.radialDataLabels.show && (m = x.renderInnerDataLabels(this.radialDataLabels, {
						hollowSize: l,
						centerX: t.centerX,
						centerY: t.centerY,
						opacity: p
					...
					for (var v = b ? t.series.length - 1 : 0; b ? v >= 0 : v < t.series.length; b ? v-- : v++) {
						var y = i.group({
							class: "apexcharts-series apexcharts-radial-series ".concat(e.globals.seriesNames[v].toString().replace(/ /g, "-"))
						});
						n.add(y), y.attr({
						...
						var w = s.fillPath(y, {
							...
							z = void 0;
						e.globals.dataChanged && (S = this.startAngle, z = Math.round(C * d.negToZero(e.globals.previousPaths[v]) / 100) + S), Math.abs(L) + Math.abs(k) >= 360 && (L -= .01), Math.abs(z) + Math.abs(S) >= 360 && (z -= .01);
						var M = L - k,
							P = Array.isArray(e.config.stroke.dashArray) ? e.config.stroke.dashArray[v] : e.config.stroke.dashArray,
							E = i.drawPath({
								d: "",
								stroke: w,
								strokeWidth: r,
						...
						var X = new Y(this.ctx);
						y.add(E), E.attr({
							id: "apexcharts-radialArc-" + v,
							index: 0,
							j: v
						});
						var I = 0;
						!X.initialAnim || e.globals.resized || e.globals.dataChanged || (I = (L - k) / 360 * e.config.chart.animations.speed, this.animDur = I / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), e.globals.dataChanged && (I = (L - k) / 360 * e.config.chart.animations.dynamicAnimation.speed, this.animDur = I / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), X.animatePaths(E, {
							centerX: t.centerX,
							centerY: t.centerY,
							endAngle: L,
							startAngle: k,
		...
		O = function () {
			function t(i, s, a) {
				e(this, t), this.ctx = i, this.w = i.w, this.xyRatios = s, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || a, this.pointsChart && (this.scatter = new C(this.ctx)), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.yaxisIndex = 0
			}
			return s(t, [{
				key: "draw",
				value: function (t, e, i) {
					...
					c = h.getLogYRatios(c);
					for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], m = [], b = 0, y = 0; y < t.length; y++) {
						...
						if (I = a.move(-1, M) + a.line(-1, M), F = a.move(-1, M) + a.line(-1, M), s.globals.previousPaths.length > 0) {
							var U = this.checkPreviousPaths({
								pathFromLine: I,
								pathFromArea: F,
								realIndex: k
							});
						...
						for (var Z = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, $ = 0; $ < Z; $++) {
							...
							s.config.chart.stacked ? (j = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? m[y - 1][$ + 1] : M, T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? j - J / c[this.yaxisIndex] : j - t[y][$ + 1] / c[this.yaxisIndex]) : T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? M - J / c[this.yaxisIndex] : M - t[y][$ + 1] / c[this.yaxisIndex], z.push(E), C.push(T);
							...
							D = Q.areaPaths, O = Q.linePaths, B = Q.pX, V = Q.pY, Y = Q.areaPath, X = Q.linePath, this.appendPathFrom && (I += a.line(E, M), F += a.line(E, M));
							...
							if (this.pointsChart) this.scatter.draw(N, $, {
								realIndex: k,
								pointsPos: K,
								zRatio: u,
								elParent: R
						...
						m.push(C), s.globals.seriesXvalues[k] = z, s.globals.seriesYvalues[k] = C, this.pointsChart || s.globals.delayedElements.push({
							el: R.node,
							index: k
						});
						var st = {
						...
						if (s.config.stroke.show && !this.pointsChart) {
							var at = null;
							at = "line" === o ? r.fillPath(N, {
								seriesNumber: k,
								i: y
							}) : s.globals.stroke.colors[k];
							for (var nt = 0; nt < O.length; nt++) {
								var rt = a.renderPaths(n({}, st, {
									pathFrom: I,
									pathTo: O[nt],
									stroke: at,
									strokeWidth: Array.isArray(s.config.stroke.width) ? s.config.stroke.width[k] : s.config.stroke.width,
						...
						if ("area" === o)
							for (var ot = r.fillPath(N, {
									seriesNumber: k
								}), lt = 0; lt < D.length; lt++) {
								var ht = a.renderPaths(n({}, st, {
									pathFrom: F,
									pathTo: D[lt],
									stroke: "none",
									strokeWidth: 0,
				...
				value: function (t) {
					...
					if ("smooth" === m) {
						var b = .35 * (a - r);
						p.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (c = x.move(r, o) + x.curve(r + b, o, a - b, n, a + 1, n), d = x.move(r + 1, o) + x.curve(r + b, o, a - b, n, a + 1, n) + x.line(a, h) + x.line(r, h) + "z") : (c = x.move(r, o), d = x.move(r, o) + "z")), u.push(c), g.push(d)) : (c += x.curve(r + b, o, a - b, n, a, n), d += x.curve(r + b, o, a - b, n, a, n)), r = a, o = n, s === e[i].length - 2 && (d = d + x.curve(r, o, a, n, a, h) + x.move(a, n) + "z", p.globals.hasNullValues || (u.push(c), g.push(d)))
					} else null === e[i][s + 1] && (c += x.move(a, n), d = d + x.line(a - l, h) + x.move(a, n)), null === e[i][s] && (c += x.move(a, n), d += x.move(a, h)), "stepline" === m ? (c = c + x.line(a, null, "H") + x.line(null, n, "V"), d = d + x.line(a, null, "H") + x.line(null, n, "V")) : "straight" === m && (c += x.line(a, n), d += x.line(a, n)), s === e[i].length - 2 && (d = d + x.line(a, h) + x.move(a, n) + "z", u.push(c), g.push(d));
					return {
						linePaths: u,
						areaPaths: g,
						pX: r,
				...
				value: function (t) {
					for (var e = t.pathFromLine, i = t.pathFromArea, s = t.realIndex, a = this.w, n = 0; n < a.globals.previousPaths.length; n++) {
						...
						("line" === r.type || "area" === r.type) && r.paths.length > 0 && parseInt(r.realIndex) === parseInt(s) && ("line" === r.type ? (this.appendPathFrom = !1, e = a.globals.previousPaths[n].paths[0].d) : "area" === r.type && (this.appendPathFrom = !1, e = a.globals.previousPaths[n].paths[0].d, i = a.globals.previousPaths[n].paths[1].d))
					}
					return {
						pathFromLine: e,
						pathFromArea: i
				...
				value: function (t) {
					var e = t.i,
						...
						o = t.lineYPosition,
						l = this.w;
					if (void 0 !== i[e][0]) n = l.config.chart.stacked ? (o = e > 0 ? r[e - 1][0] : a) - i[e][0] / s : a - i[e][0] / s;
		...
		D = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.xaxisFontSize = this.w.config.xaxis.labels.style.fontSize, this.axisFontFamily = this.w.config.xaxis.labels.style.fontFamily, this.isBarHorizontal = !("bar" !== this.w.config.chart.type || !this.w.config.plotOptions.bar.horizontal), this.xaxisForeColors = this.w.config.xaxis.labels.style.colors, this.xAxisoffX = 0, "bottom" === this.w.config.xaxis.position && (this.xAxisoffX = this.w.globals.gridHeight)
			}
			return s(t, [{
				key: "drawYaxis",
				value: function (t, e) {
					...
					if (i.config.yaxis[e].labels.show)
						for (var u = l; u >= 0; u--) {
							...
							0 !== i.config.yaxis[e].labels.rotate && x.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[e].labels.rotate, " ").concat(m.x, " ").concat(m.y, ")")), c += h
						}
					...
					if (w.show) {
						...
						var A = s.drawLine(k, i.globals.translateY + w.offsetY - 2, k, i.globals.gridHeight + i.globals.translateY + w.offsetY + 2, w.color);
				...
				value: function (t) {
					...
					if (x.show) {
						var m = i.drawLine(e.globals.padHorizontal + x.offsetX, 1 + x.offsetY, e.globals.padHorizontal + x.offsetX, e.globals.gridHeight + x.offsetY, x.color);
						s.add(m)
					}
					return s
				}
				...
				value: function (t, e) {
					...
					if (null !== o) {
						...
						e ? o.setAttribute("transform", "rotate(90 ".concat(h.x, " ").concat(h.y, ")")) : o.setAttribute("transform", "rotate(-90 ".concat(h.x, " ").concat(h.y, ")"))
					}
				}
			}, {
				...
				value: function (t, e, i, s) {
					var a = this.w,
						...
						r = 0,
						o = 20;
					return s ? (r = e.width + a.config.yaxis[t].title.offsetX + o + i.width / 2 - 15, 0 === (n += 1) && (r -= 15)) : (r = -1 * e.width + a.config.yaxis[t].title.offsetX + o + i.width / 2 - 15, this.isBarHorizontal && (o = 25, r = -1 * e.width - a.config.yaxis[t].title.offsetX - o)), {
						xPos: r,
						padd: o
					}
				}
				...
				value: function (t, e) {
					var i = this,
						...
						r = 0,
						o = 1;
					this.multipleYs = !1, s.config.yaxis.length > 1 && (this.multipleYs = !0), s.config.yaxis.map(function (l, h) {
						var c = t[h].width + e[h].width,
							d = i.multipleYs && e[h].width > 0 ? 20 : 8,
							u = i.xPaddingForYAxisTitle(h, {
								width: t[h].width
							}, {
								width: e[h].width
							}, l.opposite);
						if (s.config.yaxis.length > 1 ? c += Math.abs(u.padd) : void 0 === l.title.text ? c = c + Math.abs(u.padd) + 15 : c += Math.abs(u.padd), l.opposite) n = s.globals.gridWidth + s.globals.translateX + o + 30 + (s.globals.series.length - s.globals.collapsedSeries.length), s.globals.collapsedSeries.forEach(function (t) {
							t.index === h && (o -= c)
						}), o += c, s.globals.translateYAxisX[h] = n - l.labels.offsetX;
						else {
							var g = c + 5;
							s.globals.ignoreYAxisIndexes.indexOf(h) > -1 && (g = 0), a = i.multipleYs ? s.globals.translateX - c - r + d + parseInt(s.config.yaxis[h].labels.style.fontSize) + l.labels.offsetX : s.globals.translateX - c + t[h].width + l.labels.offsetX, r += g, s.globals.translateYAxisX[h] = a
						}
					})
				}
			}]), t
		...
		N = function () {
			...
			return s(t, [{
				...
				value: function (t, e) {
					var i = this.w;
					if ("datetime" === i.config.xaxis.type && void 0 === i.config.tooltip.x.formatter) return new T(this.ctx).formatDate(new Date(e), i.config.tooltip.x.format, !0, !0);
					return t(e)
				}
			}, {
				...
				value: function () {
					...
					return t.globals.xLabelFormatter = function (t) {
						...
						void 0 !== e.labels.formatter ? t.globals.yLabelFormatters[i] = e.labels.formatter : t.globals.yLabelFormatters[i] = function (i) {
							return d.isNumber(i) ? 0 !== t.globals.yValueDecimal ? i.toFixed(e.decimalsInFloat) : i.toFixed(0) : i
						}
					}), t.globals
				}
			}, {
			...
			return s(t, [{
				...
				value: function () {
					...
					if (e.config.xaxis.labels.show)
						for (var d = 0; d <= c - 1; d++) {
							...
							e.globals.timelineLabels.length > 0 ? (p = e.globals.timelineLabels[d].position, g = e.globals.timelineLabels[d].value) : "datetime" === e.config.xaxis.type && void 0 === h && (g = ""), (0 === (g = g.toString()).indexOf("NaN") || "undefined" === g || 0 === g.toLowerCase().indexOf("invalid") || g.toLowerCase().indexOf("infinity") >= 0 || this.drawnLabels.indexOf(g) >= 0 && !e.config.xaxis.labels.showDuplicates) && (g = ""), this.drawnLabels.push(g);
							var x = 28;
				...
				value: function (t) {
					...
					if (s.config.xaxis.axisBorder.show) {
						...
						n.add(m), new D(this.ctx).drawAxisTicks(0, o.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, n)
					}
					return n
				}
			}, {
		...
		H = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.isBarHorizontal = !("bar" !== this.w.config.chart.type || !this.w.config.plotOptions.bar.horizontal)
			}
			return s(t, [{
				key: "niceScale",
				value: function (t, e) {
					var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10;
					if (t === Number.MIN_VALUE && 0 === e || !d.isNumber(t) && !d.isNumber(e)) return t = 0, e = 1, i = 1, this.linearScale(t, e, i);
					t > e ? (console.warn("yaxis.min cannot be greater than yaxis.max"), e = t + .1) : t === e && (t = 0 === t ? 0 : t - .1, e = 0 === e ? 2 : e + .1);
					var s = [],
						a = i + 1;
					a < 2 ? a = 2 : a > 2 && (a -= 2);
					for (var n = (e - t) / a, r = Math.floor(d.log10(n)), o = Math.pow(10, r), l = parseInt(n / o) * o, h = l * Math.floor(t / l), c = l * Math.ceil(e / l), u = h; s.push(u), !((u += l) > c););
				...
				value: function (t, e, i, s) {
					...
					for (var n = a.config.yaxis[t].logBase, r = Math.log(e) / Math.log(n), o = Math.log(i) / Math.log(n), l = Math.abs(i - e) / s, h = [], c = e; s >= 0;) h.push(c), c += l, s -= 1;
				...
				value: function (t, e, i) {
					...
					i.forEach(function (t) {
						...
						n.forEach(function (i, s) {
							var a, r;
							e !== s && (a = t, r = i, a.filter(function (t) {
								return -1 !== r.indexOf(t)
							})).length > 0 && (n[e] = n[e].concat(n[s]))
						})
					});
					...
					t.forEach(function (t, i) {
						o.forEach(function (s, a) {
							s.indexOf(i) > -1 && (void 0 === h[a] && (h[a] = [], c[a] = []), h[a].push({
								key: i,
								value: t
							}), c[a].push({
								key: i,
					...
					var d = Array(o.length).fill().map(function (t, e) {
							return Number.MAX_SAFE_INTEGER
						}),
						u = Array(o.length).fill().map(function (t, e) {
					...
					h.forEach(function (t, e) {
						...
						c.forEach(function (t, i) {
							...
							t.forEach(function (i, o) {
								t[o].key === e && (void 0 !== a.yaxis[e].min && (n = a.yaxis[e].min), void 0 !== a.yaxis[e].max && (r = a.yaxis[e].max), s.setYScaleForIndex(e, n, r))
							})
						})
					})
				}
		...
		W = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.isBarHorizontal = !("bar" !== this.w.config.chart.type || !this.w.config.plotOptions.bar.horizontal), this.scales = new H(i)
			}
			return s(t, [{
				key: "init",
				value: function () {
				...
				value: function (t) {
					...
					for (var u = t; u < s; u++) {
						a.dataPoints = Math.max(a.dataPoints, o[u].length), d.isIE11() && (r = Math.min.apply(Math, c(l[u]).concat([0])));
						for (var g = 0; g < a.series[u].length; g++) null !== o[u][g] && d.isNumber(o[u][g]) ? (n = Math.max(n, h[u][g]), e = Math.min(e, l[u][g]), i = Math.max(i, l[u][g]), d.isFloat(o[u][g]) && (a.yValueDecimal = Math.max(a.yValueDecimal, o[u][g].toString().split(".")[1].length)), r > l[u][g] && l[u][g] < 0 && (r = l[u][g])) : a.hasNullValues = !0
					}
					return {
						minY: r,
						maxY: n,
				...
				value: function () {
					...
					if (t.minY = r.minY, t.maxY = r.maxY, s = r.lowestY, e.chart.stacked) {
						for (var o = [], l = [], h = 0; h < t.series[t.maxValsInArrayIndex].length; h++)
							for (var c = 0, u = 0, g = 0; g < t.series.length; g++) null !== t.series[g][h] && d.isNumber(t.series[g][h]) && (t.series[g][h] > 0 ? c = c + parseFloat(t.series[g][h]) + 1e-4 : u += parseFloat(t.series[g][h])), g === t.series.length - 1 && (o.push(c), l.push(u));
						for (var f = 0; f < o.length; f++) t.maxY = Math.max(t.maxY, o[f]), t.minY = Math.min(t.minY, l[f])
					}
					if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && s !== Number.MAX_SAFE_INTEGER) {
						var p = t.maxY - s;
						s >= 0 && s <= 10 && (p = 0), t.minY = s - 5 * p / 100, (s > 0 && t.maxY < 50 || s > 0 && t.minY < 0) && (t.minY = 0), t.maxY > 10 && (t.maxY = t.maxY + 5 * p / 100 + .6)
					}
					e.yaxis.map(function (e, s) {
						void 0 !== e.max && "number" == typeof e.max && (t.maxYArr[s] = e.max, t.maxY = i[0].max), void 0 !== e.min && "number" == typeof e.min && (t.minYArr[s] = e.min, t.minY = i[0].min)
					}), this.isBarHorizontal && (void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minY = e.xaxis.min), void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (t.maxY = e.xaxis.max)), t.isMultipleYAxis ? (this.scales.setMultipleYScales(), t.minY = s, t.yAxisScale.forEach(function (e, i) {
				...
				value: function () {
					var t, e = this.w.globals,
						i = this.w.config,
						s = "numeric" === i.xaxis.type || "datetime" === i.xaxis.type || "category" === i.xaxis.type && !e.noLabelsProvided;
					if (e.isXNumeric)
		...
		B = function () {
			...
			return s(t, [{
				...
				key: "getSeriesByName",
				value: function (t) {
					return this.w.globals.dom.baseEl.querySelector(".apexcharts-series.".concat(t.toString().replace(/ /g, "-")))
				}
			}, {
				...
				value: function () {
					...
					if (m.length > 0)
						for (var b = 0; b < m.length; b++) {
							for (var v = t.globals.dom.baseEl.querySelectorAll(".apexcharts-scatter-series .apexcharts-series[data\\:realIndex='".concat(b, "'] circle")), y = [], w = 0; w < v.length; w++) y.push({
				...
				value: function () {
					var t = this.w,
						...
						n = "middle";
					if (t.globals.noData = !0, "left" === e.align ? (s = 10, n = "start") : "right" === e.align && (s = t.globals.svgWidth - 10, n = "end"), "top" === e.verticalAlign ? a = 50 : "bottom" === e.verticalAlign && (a = t.globals.svgHeight - 50), s += e.offsetX, a = a + parseInt(e.style.fontSize) + 2, void 0 !== e.text && "" !== e.text) {
						var r = i.drawText({
							x: s,
							y: a,
							text: e.text,
		...
		V = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.lgRect = {}, this.yAxisWidth = 0, this.xAxisHeight = 0, this.isSparkline = this.w.config.chart.sparkline.enabled, this.isBarHorizontal = !("bar" !== this.w.config.chart.type || !this.w.config.plotOptions.bar.horizontal)
			}
			return s(t, [{
				key: "plotCoords",
				value: function () {
				...
				value: function (t) {
					...
					switch (e.config.grid.show && "radar" !== e.config.chart.type || (o = 0, l = 35), this.isSparkline && (t = {
						height: 0,
						width: 0
					}, l = 0, o = 0, h = 0), e.config.legend.position) {
						case "bottom":
				...
				value: function () {
					...
					if (e.globals.timelineLabels.length > 0) {
						...
						this.isBarHorizontal && (n = e.globals.yAxisScale[0].result.reduce(function (t, e) {
							return t.length > e.length ? t : e
						}, 0));
						...
						(t = {
							width: l.width,
							height: l.height
						}).width * i.length > e.globals.svgWidth - a - this.yAxisWidth && 0 !== e.config.xaxis.labels.rotate ? this.isBarHorizontal || (e.globals.rotateXLabels = !0, l = o.getTextRects(n, e.config.xaxis.labels.style.fontSize, e.config.xaxis.labels.style.fontFamily, "rotate(".concat(e.config.xaxis.labels.rotate, " 0 0)"), !1), t.height = l.height / 1.66) : e.globals.rotateXLabels = !1
					}
				...
				value: function () {
					...
					return e.config.yaxis.map(function (a, n) {
						if (a.show && a.labels.show && e.globals.yAxisScale[n].result.length) {
							...
							if (void 0 !== o && 0 !== o.length || (o = e.globals.yAxisScale[n].niceMax), t.isBarHorizontal) s = 0, o = r(o = e.globals.labels.slice().reduce(function (t, e) {
								return t.length > e.length ? t : e
							}, 0), -1);
				...
				value: function (t, e) {
					...
					return b.filter(function (t) {
						var e = 1,
							...
							n = t.value;
						void 0 !== s.config.xaxis.tickAmount && (a = s.config.xaxis.tickAmount), b.length > a && (e = Math.floor(b.length / a));
						var r = !1,
							o = !1;
		...
		G = function () {
			function t(i, s) {
				e(this, t), this.ctx = s, this.w = s.w, this.el = i, this.coreUtils = new v(this.ctx), this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = []
			}
			return s(t, [{
				key: "setupElements",
				value: function () {
					var t = this.w.globals,
						e = this.w.config,
						i = e.chart.type;
					t.axisCharts = ["line", "area", "bar", "candlestick", "radar", "scatter", "bubble", "heatmap"].indexOf(i) > -1, t.xyCharts = ["line", "area", "bar", "candlestick", "scatter", "bubble"].indexOf(i) > -1, t.chartClass = ".apexcharts" + t.cuid, t.dom.baseEl = this.el, t.dom.elWrap = document.createElement("div"), f.setAttrs(t.dom.elWrap, {
				...
				value: function (t, e) {
					...
					a.series.map(function (e, s) {
						if (void 0 !== t[s].type) {
							if ("column" === t[s].type || "bar" === t[s].type) i.config.plotOptions.bar.horizontal = !1, l.series.push(e), l.i.push(s);
								...
								if ("candlestick" !== t[s].type) throw new Error("You have specified an unrecognized chart type. Available types for this propery are line/area/column/bar");
					...
					if (a.comboCharts) {
						if (r.series.length > 0 && p.push(c.draw(r.series, "area", r.i)), l.series.length > 0)
							...
							} if (n.series.length > 0 && p.push(c.draw(n.series, "line", n.i)), h.series.length > 0 && p.push(d.draw(h.series, h.i)), o.series.length > 0) {
				...
				value: function (t, e) {
					for (var i = this.w.config, s = this.w.globals, a = 0; a < t[e].data.length; a++)
						if (void 0 !== t[e].data[a][1] && (Array.isArray(t[e].data[a][1]) && 4 === t[e].data[a][1].length ? this.twoDSeries.push(d.parseNumber(t[e].data[a][1][3])) : this.twoDSeries.push(d.parseNumber(t[e].data[a][1]))), "datetime" === i.xaxis.type) {
				...
				key: "handleFormatXY",
				value: function (t, e) {
					for (var i = this.w.config, s = this.w.globals, a = this.w.config.series.slice(), n = new T(this.ctx), r = 0; r < t[e].data.length; r++) {
						void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) && 4 === t[e].data[r].y.length ? this.twoDSeries.push(d.parseNumber(t[e].data[r].y[3])) : this.twoDSeries.push(d.parseNumber(t[e].data[r].y)));
				...
				value: function (t, e) {
					for (var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.ctx, s = this.w.config, a = this.w.globals, n = new T(i), r = 0; r < e.length; r++) {
						...
						if (this.isMultiFormat()) this.isFormat2DArray() ? this.handleFormat2DArray(t, r) : this.isFormatXY() && this.handleFormatXY(t, r), "candlestick" !== s.chart.type && "candlestick" !== t[r].type || this.handleCandleStickData(t, r), a.series.push(this.twoDSeries), a.labels.push(this.twoDSeriesX), a.seriesX.push(this.twoDSeriesX), this.fallbackToCategory || (a.isXNumeric = !0);
						else {
							if ("datetime" === s.xaxis.type) {
								a.isXNumeric = !0;
								for (var o = s.labels.length > 0 ? s.labels.slice() : s.xaxis.categories.slice(), l = 0; l < o.length; l++)
						...
						a.seriesZ.push(this.threeDSeries), void 0 !== t[r].name ? a.seriesNames.push(t[r].name) : a.seriesNames.push("series-" + parseInt(r + 1))
					}
					return this.w
				}
			}, {
				...
				value: function (t) {
					...
					if (this.fallbackToCategory = !1, this.resetGlobals(), this.isMultipleY(), s.axisCharts ? this.parseDataAxisCharts(t, a) : this.parseDataNonAxisCharts(t), this.coreUtils.getLargestSeries(), "bar" === i.chart.type && i.chart.stacked) {
						var n = new B(this.ctx);
						s.series = n.setNullSeriesToZeroValues(s.series)
					}
					this.coreUtils.getSeriesTotals(), s.axisCharts && this.coreUtils.getStackedSeriesTotals(), this.coreUtils.getPercentSeries(), (!s.isXNumeric || "numeric" === i.xaxis.type && 0 === i.labels.length && 0 === i.xaxis.categories.length) && this.handleExternalLabelsData(t)
				}
			}, {
				key: "xySettings",
				value: function () {
				...
				value: function (t, e) {
					var i, s, a = this.w.globals,
						...
						r = new R(this.ctx),
						o = new D(this.ctx);
					a.axisCharts && "radar" !== t && ("bar" === t && n.plotOptions.bar.horizontal ? (s = o.drawYaxisInversed(0), i = r.drawXaxisInversed(0), a.dom.elGraphical.add(i), a.dom.elGraphical.add(s)) : (i = r.drawXaxis(), a.dom.elGraphical.add(i), n.yaxis.map(function (t, i) {
					...
					if (e.config.chart.brush.enabled && "function" != typeof e.config.chart.events.selection) {
						...
						"function" != typeof i.w.config.chart.events.zoomed && (i.w.config.chart.events.zoomed = function () {
							...
							if (e.config.chart.brush.autoScaleYaxis) {
								...
								n = a = r, i.w.config.series.forEach(function (t) {
									t.data.forEach(function (t) {
										t[0] <= s.xaxis.max && t[0] >= s.xaxis.min && (t[1] > n && null !== t[1] && (n = t[1]), t[1] < a && null !== t[1] && (a = t[1]))
									})
								}), a *= .95, n *= 1.05
							}
							var o = {
	...
	function $(t, e) {
		try {
			...
			if (e && ("object" == typeof e || "function" == typeof e)) {
				...
				if ("function" == typeof i) return void tt((s = i, a = e, function () {
					s.apply(a, arguments)
				}), t)
			}
	...
	var et, it, st = function () {
		...
		at = function () {
			...
			return s(t, [{
				...
				key: "renderGrid",
				value: function () {
					for (var t, e = this.w, i = new f(this.ctx), s = e.config.grid.strokeDashArray, a = i.group({
							class: "apexcharts-grid"
						}), n = 8, r = 0; r < e.globals.series.length && (void 0 !== e.globals.yAxisScale[r] && (n = e.globals.yAxisScale[r].result.length - 1), !(n > 2)); r++);
					if (!(!e.config.plotOptions.bar.horizontal || "bar" !== e.config.chart.type)) {
						if (t = n, e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show)
							for (var o, l = e.globals.padHorizontal, h = e.globals.gridHeight, c = 0; c < t + 1 && (o = l = l + e.globals.gridWidth / t + .3, c !== t - 1); c++) {
								if (e.config.grid.xaxis.lines.show) {
									var d = i.drawLine(l, 0, o, h, e.config.grid.borderColor, s);
									d.node.classList.add("apexcharts-gridline"), a.add(d), this.animX && this.animateLine(d, {
										x1: 0,
										x2: 0
									}, {
										x1: l,
						...
						if (t = this.xaxisLabels.length, e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show) {
							var b, v = e.globals.padHorizontal,
								y = e.globals.gridHeight;
							if (e.globals.timelineLabels.length > 0)
								for (var w = 0; w < t; w++) {
									if (v = this.xaxisLabels[w].position, b = this.xaxisLabels[w].position, e.config.grid.xaxis.lines.show && v > 0 && v < e.globals.gridWidth) {
										var k = i.drawLine(v, 0, b, y, e.config.grid.borderColor, s);
										k.node.classList.add("apexcharts-gridline"), a.add(k), this.animX && this.animateLine(k, {
											x1: 0,
											x2: 0
										}, {
											x1: v,
									...
									for (var A = t, S = 0; S < A; S++) {
										var C = A;
										if (e.globals.isXNumeric && "bar" !== e.config.chart.type && (C -= 1), b = v += e.globals.gridWidth / C, S === C - 1) break;
										if (e.config.grid.xaxis.lines.show) {
											var L = i.drawLine(v, 0, b, y, e.config.grid.borderColor, s);
											L.node.classList.add("apexcharts-gridline"), a.add(L), this.animX && this.animateLine(L, {
												x1: 0,
												x2: 0
											}, {
												x1: v,
					...
					return this.drawGridBands(a, t, n), {
						el: a,
						xAxisTickWidth: e.globals.gridWidth / t
					}
				}
			}, {
				key: "drawGridBands",
				value: function (t, e, i) {
					...
					if (void 0 !== s.config.grid.column.colors && s.config.grid.column.colors.length > 0)
						for (var u = s.globals.padHorizontal, g = s.globals.padHorizontal + s.globals.gridWidth / e, p = s.globals.gridHeight, x = 0, m = 0; x < e; x++, m++) {
			...
			return s(t, [{
				...
				value: function () {
					...
					for (var n = t.globals.legendFormatter, r = 0; r <= i.length - 1; r++) {
						...
						var d = t.config.legend.markers.offsetX,
							...
							y = c.style;
						y.background = s[r], y.color = s[r], y.height = Array.isArray(g) ? parseFloat(g[r]) + "px" : parseFloat(g) + "px", y.width = Array.isArray(p) ? parseFloat(p[r]) + "px" : parseFloat(p) + "px", y.left = Array.isArray(d) ? d[r] : d, y.top = Array.isArray(u) ? u[r] : u, y.borderWidth = Array.isArray(x) ? x[r] : x, y.borderColor = Array.isArray(m) ? m[r] : m, y.borderRadius = Array.isArray(b) ? parseFloat(b[r]) + "px" : parseFloat(b) + "px", t.config.legend.markers.customHTML && (Array.isArray(t.config.legend.markers.customHTML) ? c.innerHTML = t.config.legend.markers.customHTML[r]() : c.innerHTML = t.config.legend.markers.customHTML()), f.setAttrs(c, {
							rel: r + 1,
							"data:collapsed": l
						...
						A || (A = t.config.chart.foreColor), k.style.color = A, k.style.fontSize = parseFloat(t.config.legend.fontSize) + "px", k.style.fontFamily = e || t.config.chart.fontFamily, f.setAttrs(k, {
							rel: r + 1,
							"data:collapsed": l
						}), w.appendChild(c), w.appendChild(k);
						var S = new v(this.ctx);
						if (!t.config.legend.showForZeroSeries) 0 === S.getSeriesTotalByIndex(r) && S.seriesHaveSameValues(r) && !S.isSeriesNull(r) && -1 === t.globals.collapsedSeriesIndices.indexOf(r) && w.classList.add("apexcharts-hidden-zero-series");
						t.config.legend.showForNullSeries || S.isSeriesNull(r) && -1 === t.globals.collapsedSeriesIndices.indexOf(r) && w.classList.add("apexcharts-hidden-null-series"), t.globals.dom.elLegendWrap.appendChild(w), t.globals.dom.elLegendWrap.classList.add(t.config.legend.horizontalAlign), t.globals.dom.elLegendWrap.classList.add("position-" + t.config.legend.position), w.classList.add("apexcharts-legend-series"), w.style.margin = "".concat(t.config.legend.itemMargin.horizontal, "px ").concat(t.config.legend.itemMargin.vertical, "px"), t.globals.dom.elLegendWrap.style.width = t.config.legend.width ? t.config.legend.width + "px" : "", t.globals.dom.elLegendWrap.style.height = t.config.legend.height ? t.config.legend.height + "px" : "", f.setAttrs(w, {
							rel: r + 1,
							"data:collapsed": l
						}), l && w.classList.add("inactiv`e-legend"), t.config.legend.onItemClick.toggleDataSeries || w.classList.add("no-click")
					}
				...
				value: function (t) {
					...
					if ("heatmap" !== e.config.chart.type) !t.target.classList.contains("inactive-legend") && i && new B(this.ctx).toggleSeriesOnHover(t, t.target);
						...
						this.ctx.fireEvent("legendHover", [this.ctx, s, this.w]), new B(this.ctx).highlightRangeInSeries(t, t.target)
					}
				}
			}, {
				key: "onLegendClick",
				...
				value: function () {
					...
					if (t.globals.axisCharts ? t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:realIndex]").forEach(function (t) {
						...
						}), e.sort(), t.globals.collapsedSeries.length > 0) {
						for (var i = t.globals.risingSeries.slice(), s = t.config.series.slice(), a = 0; a < t.globals.collapsedSeries.length; a++) {
							var n = e.indexOf(t.globals.collapsedSeries[a].index); - 1 !== n && (t.globals.axisCharts ? s[n].data = t.globals.collapsedSeries.slice()[a].data.slice() : s[n] = t.globals.collapsedSeries.slice()[a].data, i.push(n))
						}
						t.globals.collapsedSeries = [], t.globals.collapsedSeriesIndices = [], t.globals.risingSeries = i, t.config.series = s, this.ctx._updateSeries(t.config.series, t.config.chart.animations.dynamicAnimation.enabled)
					}
				}
			}, {
				...
				value: function (t, e) {
					...
					if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
						...
						var s = null,
							a = null;
						if (i.globals.risingSeries = [], i.globals.axisCharts ? (s = i.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")), a = parseInt(s.getAttribute("data:realIndex"))) : (s = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")), a = parseInt(s.getAttribute("rel")) - 1), e) {
						...
						var n = new y({}),
							r = function () {
								...
								if (r > s) {
									...
									for (var l = 0; l < a.length; l++) r < a[l].breakpoint && (t = d.extend(n, t), t = v.extendArrayProps(t, a[l].options), t = d.extend(i.config, t), e.overrideResponsiveOptions(t))
							};
						if (t) {
		...
		ot = function () {
			...
			return s(t, [{
				...
				value: function (t, e) {
					...
					if ((i = null === i && ("bar" === s.config.chart.type && s.config.plotOptions.bar.distributed || "heatmap" === s.config.chart.type && s.config.plotOptions.heatmap.colorScale.inverse)) && (a = s.globals.series[0].length * s.globals.series.length), t.length < a)
		...
		lt = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					for (var g, f = null, p = null, x = [], m = 0; m < r.globals.seriesXvalues.length; m++) x.push([r.globals.seriesXvalues[m][0] - 1e-6].concat(r.globals.seriesXvalues[m]));
		...
		ct = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					if (null !== e && (n = s.globals.gridWidth / r * e), "tickWidth" === s.config.xaxis.crosshairs.width || "barWidth" === s.config.xaxis.crosshairs.width ? n + i.xcrosshairsWidth > s.globals.gridWidth && (n = s.globals.gridWidth - i.xcrosshairsWidth) : null !== e && (n += s.globals.gridWidth / r / 2), n < 0 && (n = 0), n > s.globals.gridWidth && (n = s.globals.gridWidth), null !== a && (a.setAttribute("x", n), a.classList.add("active")), i.blxaxisTooltip) {
						var o = n;
				...
				value: function (t, e) {
					...
					l.setAttribute("r", o), l.setAttribute("cx", i), l.setAttribute("cy", s), this.moveXCrosshairs(i), n.fixedTooltip || this.moveTooltip(i, s, o)
				}
			}, {
		...
		dt = function () {
			...
			return s(t, [{
				...
				value: function () {
					for (var t = this.w, e = new f(this.ctx), i = new S(this.ctx), s = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series"), a = 0; a < s.length; a++) {
		...
		ut = function () {
			function t(i) {
				e(this, t), a(this, "getAttr", function (t, e) {
					return parseFloat(t.target.getAttribute(e))
				}), this.w = i.w, this.ttCtx = i
			}
			return s(t, [{
				...
				value: function (t) {
					...
					if (s.target.classList.contains("apexcharts-marker")) {
						...
						if (l.tooltipLabels.drawSeriesTexts({
							...
							}), l.marker.enlargeCurrentPoint(i, a.paths), n = h, r = c - 1.4 * l.tooltipRect.ttHeight, l.w.config.tooltip.followCursor) {
				...
				value: function (t) {
					...
					if (n.isBarHorizontal && n.hasBars() || !a.config.tooltip.shared) {
						var d = this.getBarTooltipXY({
							e: i,
							opt: s
						});
						l = d.x, h = d.y, c = d.i, e = Array.isArray(a.config.stroke.width) ? a.config.stroke.width[c] : a.config.stroke.width, o = l
					} else a.globals.comboCharts || a.config.tooltip.shared || (o /= 2);
					if (isNaN(h) && (h = a.globals.svgHeight - n.tooltipRect.ttHeight), l + n.tooltipRect.ttWidth > a.globals.gridWidth ? l -= n.tooltipRect.ttWidth : l < 0 && (l += n.tooltipRect.ttWidth), n.w.config.tooltip.followCursor) {
						var u = n.getElGrid().getBoundingClientRect();
						h = n.e.clientY - u.top
					}
					null === n.tooltip && (n.tooltip = a.globals.dom.baseEl.querySelector(".apexcharts-tooltip")), a.config.tooltip.shared || (a.globals.comboChartsHasBars ? n.tooltipPosition.moveXCrosshairs(o + e / 2) : n.tooltipPosition.moveXCrosshairs(o)), !n.fixedTooltip && (!a.config.tooltip.shared || n.isBarHorizontal && n.hasBars()) && (r.style.left = l + a.globals.translateX + "px", n.tooltipRect.ttHeight + h > a.globals.gridHeight ? (h = a.globals.gridHeight - n.tooltipRect.ttHeight + a.globals.translateY, r.style.top = h + "px") : r.style.top = h + a.globals.translateY - n.tooltipRect.ttHeight / 2 + "px")
				}
			}, {
				key: "getBarTooltipXY",
				value: function (t) {
					...
					if (c.contains("apexcharts-bar-area") || c.contains("apexcharts-candlestick-area")) {
						...
						a = parseInt(d.getAttribute("j")), r = parseInt(d.parentNode.getAttribute("rel")) - 1, s.globals.comboCharts && (r = parseInt(d.parentNode.getAttribute("data:realIndex"))), n.tooltipLabels.drawSeriesTexts({
							ttItems: i.ttItems,
							i: r,
							j: a,
							shared: !n.showOnIntersect && s.config.tooltip.shared
						}), s.config.tooltip.followCursor ? s.config.plotOptions.bar.horizontal ? (o = b - g.left + 15, l = m - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2, l = e.clientY - g.top - n.tooltipRect.ttHeight / 2 - 15) : s.config.plotOptions.bar.horizontal ? ((o = x) < n.xyRatios.baseLineInvertedY && (o = x - n.tooltipRect.ttWidth), l = m - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2, l = m)
					}
					return {
						x: o,
						y: l,
		...
		gt = function () {
			...
			return s(t, [{
				...
				value: function () {
					...
					e.blxaxisTooltip && (null === t.globals.dom.baseEl.querySelector(".apexcharts-xaxistooltip") && (e.xaxisTooltip = document.createElement("div"), e.xaxisTooltip.setAttribute("class", s), a.appendChild(e.xaxisTooltip), e.xaxisTooltipText = document.createElement("div"), e.xaxisTooltipText.classList.add("apexcharts-xaxistooltip-text"), e.xaxisTooltipText.style.fontFamily = t.config.xaxis.tooltip.style.fontFamily || t.config.chart.fontFamily, e.xaxisTooltipText.style.fontSize = t.config.xaxis.tooltip.style.fontSize, e.xaxisTooltip.appendChild(e.xaxisTooltipText)))
				}
			}, {
				...
				value: function () {
					...
					"bar" === t.config.chart.type && t.config.plotOptions.bar.horizontal && (e.xcrosshairsWidth = 0), null !== i && e.xcrosshairsWidth > 0 && i.setAttribute("width", e.xcrosshairsWidth)
				}
			}, {
		...
		ft = function () {
			...
			return s(t, [{
				...
				value: function (t, e) {
					for (var i = this, s = this, a = function (a) {
							...
							["mousemove", "touchmove", "mouseout", "touchend"].map(function (e) {
								return t[a].addEventListener(e, s.seriesHover.bind(s, n), {
									capture: !1,
									passive: !0
								})
							})
				...
				value: function (t) {
					...
					}, i.e = a, !i.hasBars() || n.globals.comboCharts || i.isBarShared) || n.config.tooltip.onDatasetHover.highlightDataSeries && new B(e).toggleSeriesOnHover(a, a.target.parentNode);
				...
				value: function (t) {
					...
					var u = r.globals.xyCharts || "bar" === r.config.chart.type && !this.isBarHorizontal && this.hasBars() && r.config.tooltip.shared || r.globals.comboCharts && this.hasBars;
					if ("bar" === r.config.chart.type && this.isBarHorizontal && this.hasBars() && (u = !1), "mousemove" === a.type || "touchmove" === a.type) {
						if (null !== h && h.classList.add("active"), null !== this.ycrosshairs && this.blyaxisTooltip && this.ycrosshairs.classList.add("active"), u && !this.showOnIntersect) {
							...
							if (null !== g) {
								...
								void 0 !== r.globals.series[g][e] ? r.config.tooltip.shared && this.tooltipUtil.isXoverlap(e) && this.tooltipUtil.isinitialSeriesSameLen() ? this.create(this, g, e, n.ttItems) : this.create(this, g, e, n.ttItems, !1) : this.tooltipUtil.isXoverlap(e) && this.create(this, 0, e, n.ttItems)
						...
						if (this.blyaxisTooltip)
							for (var p = 0; p < r.config.yaxis.length; p++) this.axesTooltip.drawYaxisTooltipText(p, d, this.xyRatios);
				...
				value: function (t) {
					...
					"radialBar" === a.config.chart.type ? h = a.globals.dom.baseEl.querySelector(".apexcharts-radialbar") : (h = a.globals.dom.baseEl.querySelector(".apexcharts-pie"), o = parseInt(h.getAttribute("data:innerTranslateX")), l = parseInt(h.getAttribute("data:innerTranslateY")));
					...
					if ("mousemove" === e.type || "touchmove" === e.type) {
						...
						u < 0 ? u = 0 : u + s.ttWidth > a.globals.gridWidth && (u = c - d.left - s.ttWidth + o), g < 0 && (g = s.ttHeight + 20), r.style.left = u + a.globals.translateX + "px", r.style.top = g + "px"
				...
				value: function (t, e, i, s) {
					...
					if (a) {
						if (r.tooltipLabels.drawSeriesTexts({
							...
							}), o && (n.globals.markers.largestSize > 0 ? r.marker.enlargePoints(i) : r.tooltipPosition.moveDynamicPointsOnHover(i)), this.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(l), this.barSeriesHeight > 0)) {
		...
		pt = function () {
			...
			return s(t, [{
				...
				value: function () {
					...
					}), t.config.chart.toolbar.tools.reset && t.config.chart.zoom.enabled && i.push({
						el: this.elZoomReset,
					...
					for (var s = 0; s < i.length; s++) f.setAttrs(i[s].el, {
						class: i[s].class,
						title: i[s].title
					}), i[s].el.innerHTML = i[s].icon, e.appendChild(i[s].el);
					...
					for (var a = [{
						...
						}], n = 0; n < a.length; n++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[n].innerHTML = a[n].title, f.setAttrs(this.elMenuItems[n], {
		...
		xt = function (t) {
			...
			return r(i, pt), s(i, [{
				...
				value: function (t) {
					...
					if (s.config.yaxis.forEach(function (t, e) {
						...
						if (s.globals.zoomEnabled) {
							...
							"x" === i ? a.ctx._updateOptions({
								xaxis: p
							}, !1, a.w.config.chart.animations.dynamicAnimation.enabled) : "y" === i ? a.ctx._updateOptions({
								yaxis: f
							}, !1, a.w.config.chart.animations.dynamicAnimation.enabled) : a.ctx._updateOptions({
								xaxis: p,
								yaxis: f
						...
						m = {
							min: h,
							max: c
						}, "xy" !== i && "y" !== i || (b = d.clone(s.config.yaxis)).forEach(function (t, e) {
				...
				value: function (t, e, i) {
					var s = this.w,
						a = this.xyRatios;
					"left" === t ? (e = s.globals.minX + s.globals.gridWidth / 15 * a.xRatio, i = s.globals.maxX + s.globals.gridWidth / 15 * a.xRatio) : "right" === t && (e = s.globals.minX - s.globals.gridWidth / 15 * a.xRatio, i = s.globals.maxX - s.globals.gridWidth / 15 * a.xRatio), (e < s.globals.initialminX || i > s.globals.initialmaxX) && (e = s.globals.minX, i = s.globals.maxX), this.ctx._updateOptions({
						xaxis: {
							min: e,
							max: i
						}
	...
	et = "undefined" != typeof window ? window : void 0, it = function (e, i) {
			...
			s.did = 1e3, s.eid = function (t) {
				...
				move: function (t, e) {
					...
					if (t -= i.x, e -= i.y, !isNaN(t) && !isNaN(e))
						for (var s = this.value.length - 1; s >= 0; s--) this.value[s] = [this.value[s][0] + t, this.value[s][1] + e];
					return this
				},
				size: function (t, e) {
					var i, s = this.bbox();
			...
			s.PathArray = function (t, e) {
				...
				move: function (t, e) {
					var i = this.bbox();
					if (t -= i.x, e -= i.y, !isNaN(t) && !isNaN(e))
						for (var s, a = this.value.length - 1; a >= 0; a--) "M" == (s = this.value[a][0]) || "L" == s || "T" == s ? (this.value[a][1] += t, this.value[a][2] += e) : "H" == s ? this.value[a][1] += t : "V" == s ? this.value[a][1] += e : "C" == s || "S" == s || "Q" == s ? (this.value[a][1] += t, this.value[a][2] += e, this.value[a][3] += t, this.value[a][4] += e, "C" == s && (this.value[a][5] += t, this.value[a][6] += e)) : "A" == s && (this.value[a][6] += t, this.value[a][7] += e);
					return this
				},
				size: function (t, e) {
					var i, s, a = this.bbox();
				...
				extend: {
					...
					initAnimations: function () {
						...
						for (t in a.animations)
							for (i = this.target()[t](), Array.isArray(i) || (i = [i]), Array.isArray(a.animations[t]) || (a.animations[t] = [a.animations[t]]), e = i.length; e--;) a.animations[t][e] instanceof s.Number && (i[e] = new s.Number(i[e])), a.animations[t][e] = i[e].morph(a.animations[t][e]);
				...
				extend: {
					...
					transform: function (t) {
						...
						}), (e = new this.constructor).x = i, e.width = a - i, e.y = n, e.height = r - n, b(e), e
					}
				}
			}), s.BBox = s.invent({
				create: function (t) {
				...
				create: function (e) {
					var i, a, n, r, o, l, h, c = 1,
						d = 1,
						u = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
					if (e instanceof s.Element) {
						for (l = e, h = e, o = (e.attr("viewBox") || "").match(u), e.bbox, n = new s.Number(e.width()), r = new s.Number(e.height());
							"%" == n.unit;) c *= n.value, n = new s.Number(l instanceof s.Doc ? l.parent().offsetWidth : l.parent().width()), l = l.parent();
						for (;
			...
			function m(t) {
				for (var i = t.childNodes.length - 1; i >= 0; i--) t.childNodes[i] instanceof e.SVGElement && m(t.childNodes[i]);
		...
		}) : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) ? module.exports = et.document ? it(et, et.document) : function (t) {
		...
		function () {
			...
			function s(t) {
				...
				switch (t[0]) {
					...
					case "A":
						t = (e = function (t, e) {
							var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, m, b, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]),
								P = Math.abs(e[2]),
								E = e[3] % 360,
								T = e[4],
								X = e[5],
							...
							for (m[0][0] = m[0][1].clone(), m[m.length - 1][2] = m[m.length - 1][1].clone(), a = (new SVG.Matrix).rotate(E).scale(M, P).rotate(-E), k = 0, A = m.length; k < A; k++) m[k][0] = m[k][0].transform(a), m[k][1] = m[k][1].transform(a), m[k][2] = m[k][2].transform(a);
							for (k = 1, A = m.length; k < A; k++) w = m[k - 1][2], S = w.x, C = w.y, w = m[k][0], L = w.x, z = w.y, w = m[k][1], Y = w.x, I = w.y, D.push(["C", S, C, L, z, Y, I]);
							return D
						}(this.pos, t))[0]
				}
	...
	return function (t, e) {
		...
		function () {
			...
			var s, a, n = (s = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (t) {
		...
		function () {
			...
			return s(i, [{
				...
				value: function (t, e, i) {
					...
					if (a.noData = !1, a.animationEnded = !1, i || this.responsive.checkResponsiveConfig(e), null === this.el) return a.animationEnded = !0, null;
					...
					return {
						elGraph: o,
						xyRatios: r,
						elInner: s.globals.dom.elGraphical,
						dimensions: l
					}
				}
			}, {
				...
				value: function () {
					...
					return new U(function (s, a) {
						...
						if ((null === t || i.globals.allSeriesCollapsed) && e.series.handleNoData(), e.core.drawAxis(i.config.chart.type, t.xyRatios), e.grid = new at(e), "back" === i.config.grid.position && e.grid.drawGrid(), "back" === i.config.annotations.position && e.annotations.drawAnnotations(), t.elGraph instanceof Array)
				...
				value: function (t) {
					...
					})), this.revertDefaultAxisMinMax()), t.xaxis && (t.xaxis.min || t.xaxis.max) && this.forceXAxisUpdate(t), a.globals.collapsedSeriesIndices.length > 0 && this.clearPreviousPaths(), this._updateOptions(t, e, i, s)
				}
			}, {
				key: "_updateOptions",
				value: function (e) {
					...
					this.getSyncedCharts().forEach(function (n) {
						var r = n.w;
						return r.globals.shouldAnimate = s, i || (r.globals.resized = !0, r.globals.dataChanged = !0, s && n.series.getPreviousPaths()), e && "object" === t(e) && (n.config = new y(e), e = v.extendArrayProps(n.config, e), r.config = d.extend(r.config, e), a && (r.globals.lastXAxis = [], r.globals.lastYAxis = [], r.globals.initialConfig = d.extend({}, r.config), r.globals.initialSeries = JSON.parse(JSON.stringify(r.config.series)))), n.update(e)
					})
				}
			}, {
				key: "updateSeries",
				...
				value: function (t, e) {
					var i, s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
						a = this.w;
					return this.w.globals.shouldAnimate = e, a.globals.dataChanged = !0, a.globals.allSeriesCollapsed && (a.globals.allSeriesCollapsed = !1), e && this.series.getPreviousPaths(), t[0].data ? (i = t.map(function (t, e) {
						return n({}, a.config.series[e], {
							name: t.name ? t.name : a.config.series[e].name,
							data: t.data
						})
