...
namespace Ayda.Ecommerce.Data.Migrations
{
    ...
    [Migration("20230314173655_InitialInvoice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.Finances.FeaturesInvoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FeaturesInvoices");
                });

            modelBuilder.Entity("Ayda.Ecommerce.Domains.Finances.Invoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("FeaturesInvoiceId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.Finances.InvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.Slider.Possition", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4783),
                            IsShow = true,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4789),
                            IsShow = true,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4792),
                            IsShow = true,
                            PossitionNameFA = "چپ",
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4796),
                            IsShow = true,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4800),
                            IsShow = true,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4805),
                            IsShow = true,
                        ...
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4809),
                            IsShow = true,
                            PossitionNameFA = "وسط",
                        ...
                        {
                            Id = 8,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4812),
                            IsShow = true,
                        ...
                        {
                            Id = 9,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4816),
                            IsShow = true,
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.User.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4747),
                            ...
                            Password = "AQAAAAEAACcQAAAAEO8xGGilHM//iz/2R39XLIlpYZYS3yYOyQrIODPW6rR94bHnfMomIMExbbsyMw0hcA==",
                            PhoneConfirm = true,
                            RoleId = 1,
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.User.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4656),
                            IsShow = true,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 3, 14, 21, 6, 55, 415, DateTimeKind.Local).AddTicks(4705),
                            IsShow = true,
                            Name = "Employee"
                        });
                });
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.Finances.Invoice", b =>
                {
                    b.HasOne("Ayda.Ecommerce.Domains.Finances.FeaturesInvoice", "FeaturesInvoice")
                        .WithMany("Invoices")
                        .HasForeignKey("FeaturesInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ayda.Ecommerce.Domains.Finances.InvoiceItem", b =>
                {
                    b.HasOne("Ayda.Ecommerce.Domains.Finances.Invoice", "Invoice")
